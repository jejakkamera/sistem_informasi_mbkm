...
class Ta_s1 extends CI_Controller {
    ...
    public function __construct()
	{
        ...
        $action='get';
        $access = $this->Master_model->cek_akses('baak_ta_s1',$level,$action);
        if($access==0){
    ...
    public function json_list_periode_s1(){
        ...
        echo $this->Baak_dt->json_list_periode_s1();
    }
    ...
    public function periode_tugas_akhir_add(){
        ...
        $data_master=$this->baak_form->periode_tugas_akhir_add();
    ...
    public function periode_tugas_akhir_add_action(){
        ...
        $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
            ...
            if ( ($this->form_validation->run() == TRUE)   ) {
				...
				$this->Master_model->insert_query('ta_s1_list',$data);

                $text = $this->alert->success('success add : periode Tugas Akhir');
				$this->session->set_flashdata('message', $text);
				redirect("baak/tugas_akhir/ta_s1/list_periode");
            }else{
    ...
    public function periode_edit($periode){
        ...
        $data_master=$this->baak_form->periode_ta_s1_edit($periode);
        $data_masters=get_object_vars($this->Master_model->master_get(['periode'=>$periode],'ta_s1_list'));
		if(!$data_masters){
    ...
    public function periode_edit_action($periode){
        ...
        $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
            ...
            if ( ($this->form_validation->run() == TRUE)   ) {
				...
				$this->Master_model->update_query(['periode'=>$periode], $data, 'ta_s1_list');
    ...
    public function json_periode_rule($periode){
        ...
        header('Content-Type: application/json');
        echo $this->Baak_dt->json_periode_rule_ta_s1($periode);
    }

    public function periode_rule($periode){
        $this->load->model('tabel/Baak_t', 'baak_tabel');
            $data_master=$this->baak_tabel->periode_rule_ta_s1($periode);
    ...
    public function periode_rule_add($periode){
        ...
        $data_master=$this->baak_form->periode_rule_add_ta_s1($periode);
        ...
        $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
            ...
            if ( ($this->form_validation->run() == TRUE)   ) {
                ...
                if($result->status_code!='000'){
                    ...
                    $this->session->set_flashdata('message', $text);
                    redirect("baak/tugas_akhir/ta_s1/periode_rule_add/".$periode);
                }  
                $result = ($result->data);
				...
				$this->Master_model->insert_query('ta_s1_rule',$data);

                $text = $this->alert->success('success add : TA rule');
				$this->session->set_flashdata('message', $text);
				redirect("baak/tugas_akhir/ta_s1/periode_rule/".$periode);
            }else{
    ...
    public function dashboard($periode){
        ...
        $this->header();
        $this->load->view('baak/tugas_akhir_s1/dashboard',
            [
                'periode'=>$periode,
            ]
        );
    ...
    public function pendaftar($periode){
        ...
        $data_master=$this->baak_tabel->list_pendaftar_ta_s1($periode);
        $this->load->view('master/master_list',
            [
                'data_detail'=>$data_master['data_detail'],
                'data_isi'=>$data_master['data_isi'],
    ...
    public function json_list_pendaftar_ta_s1($periode){
        $this->load->model('datatable/Baak_dt', 'Baak_dt');
        
        header('Content-Type: application/json');
        echo $this->Baak_dt->json_list_pendaftar_ta_s1($periode);
    }
    ...
    public function plot_dosen($id_trx,$periode){
        ...
        $data_file = $this->Master_model->master_get(['id_trx'=>$id_trx], 'v_ta_s1_mhs_list');

        $this->load->model('form/Baak_f', 'baak_form');
        $data_master=$this->baak_form->ta_s1_plot_dosen($id_trx,$data_file);
        ...
        if($data_file){
            ...
            $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
                ...
                if ( ($this->form_validation->run() == TRUE)   ) {
                    ...
                    $this->Master_model->update_query(['id_trx'=>$id_trx], $data, 'ta_s1_mhs_list');
                    $text = $this->alert->success('data update');
                    $this->session->set_flashdata('message', $text);
                    redirect("baak/tugas_akhir/ta_s1/pendaftar/".$data_file->periode);
    ...
    public function all_data($periode){
        ...
        $data_master=$this->baak_tabel->all_data_ta_s1($periode);
        $this->load->view('master/master_list',
            [
                'data_detail'=>$data_master['data_detail'],
                'data_isi'=>$data_master['data_isi'],
    ...
    public function json_all_data_ta_s1($periode){
        $this->load->model('datatable/Baak_dt', 'Baak_dt');
        
        header('Content-Type: application/json');
        echo $this->Baak_dt->json_all_data_ta_s1($periode);
    }
    ...
    public function list_sidang($sidang,$periode){
        ...
        $data_master=$this->baak_tabel->list_sidang_ta_s1($sidang,$periode);
        $this->load->view('master/master_list',
            [
                'data_detail'=>$data_master['data_detail'],
                'data_isi'=>$data_master['data_isi'],
    ...
    public function json_list_sidang_ta_s1($sidang,$periode){
        $this->load->model('datatable/Baak_dt', 'Baak_dt');
        
        header('Content-Type: application/json');
        echo $this->Baak_dt->json_list_sidang_ta_s1($sidang,$periode);
    }
    ...
    public function sidang_add($sidang,$periode){
        ...
        $this->load->model('form/Baak_f', 'baak_form');
        $data_master=$this->baak_form->sidang_ta_s1_add($sidang,$periode);
    ...
    public function sidang_ta_s1_add_action($sidang,$periode){
        $this->form_validation->set_rules('buka_daftar', 'buka_daftar', 'trim|required|xss_clean');
        $this->form_validation->set_rules('tutup_daftar', 'tutup_daftar', 'trim|required|xss_clean');
        ...
        $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
            ...
            if ( ($this->form_validation->run() == TRUE)   ) {
				...
				$this->Master_model->insert_query('ta_s1_jadwal_sidang',$data);

                $text = $this->alert->success('success add : jadwal sidang');
				$this->session->set_flashdata('message', $text);
				redirect("baak/tugas_akhir/ta_s1/list_sidang/".$sidang.'/'.$periode);
            }else{
                $this->sidang_add($sidang,$periode);
            }
    }

    public function sidang_ta_s1_edit($id_trx,$periode){
        $this->header();
        $this->load->view('baak/tugas_akhir_s1/dashboard',
            [
                'periode'=>$periode,
        ...
        $this->load->model('form/Baak_f', 'baak_form');
        $data_master=$this->baak_form->sidang_ta_s1_edit($id_trx,$periode);
        $data_masters=get_object_vars($this->Master_model->master_get(['id_trx'=>$id_trx],'ta_s1_jadwal_sidang'));
    ...
    public function sidang_ta_s1_edit_action($id_trx,$periode){
        $data_masters=$this->Master_model->master_get(['id_trx'=>$id_trx],'ta_s1_jadwal_sidang');
        if(!$data_masters){
            $text = $this->alert->danger('Record not found');
            $this->session->set_flashdata('message', $text);
            redirect("baak/tugas_akhir/ta_s1/list_periode");
        ...
        $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
            ...
            if ( ($this->form_validation->run() == TRUE)   ) {
                ...
                $this->Master_model->update_query(['id_trx'=>$id_trx], $data, 'ta_s1_jadwal_sidang');

                $text = $this->alert->success('success edit : jadwal sidang');
				$this->session->set_flashdata('message', $text);
				redirect("baak/tugas_akhir/ta_s1/list_sidang/".$data_masters->sidang.'/'.$periode);
            }else{
                $this->sidang_ta_s1_edit($id_trx,$periode);
            }
    }
    ...
    public function plot_jadwal_sidang($id_trx,$periode){
        ...
        $data_master=$this->baak_tabel->list_jadwal_sidang_ta_s1($id_trx,$data_masters);
        $this->load->view('master/master_list',
            [
                'data_detail'=>$data_master['data_detail'],
                'data_isi'=>$data_master['data_isi'],
    ...
    public function json_list_jadwal_sidang_ta_s1($id_trx){
        $this->load->model('datatable/Baak_dt', 'Baak_dt');
        
        header('Content-Type: application/json');
        echo $this->Baak_dt->json_list_jadwal_sidang_ta_s1($id_trx);
    }

    public function plot_sidang_ta_s1($id_trx,$periode){
        $this->header();
        $this->load->view('baak/tugas_akhir_s1/dashboard',
            [
                'periode'=>$periode,
        ...
        $this->load->model('form/Baak_f', 'baak_form');
        $data_master=$this->baak_form->plot_sidang_ta_s1($id_trx,$data_file);
    ...
    public function plot_sidang_ta_s1_action($id_trx){
        $data_file = $this->Master_model->master_get(['id_trx'=>$id_trx], 'v_ta_s1_mhs_sidang');
        if($data_file){
            ...
            $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
                ...
                if ( ($this->form_validation->run() == TRUE)   ) {
                    ...
                    $this->Master_model->update_query(['id_trx'=>$id_trx], $data, 'ta_s1_mhs_sidang');
                    ...
                    $text = $this->alert->success('data update');
                    $this->session->set_flashdata('message', $text);
                    redirect("baak/tugas_akhir/ta_s1/plot_jadwal_sidang/".$data_file->id_sidang."/".$data_file->periode);

                }else{
                    $this->plot_sidang_ta_s1($id_trx,$data_file->periode);
                }
    ...
    public function penilaian($id_trx,$periode){
        $data_masters=($this->Master_model->master_get(['id_trx' => $id_trx],'v_ta_s1_mhs_sidang'));
        if($data_masters){
            ...
            $magang_nilai=($this->Master_model->master_result(['id_trx_sidang' => $id_trx],'ta_s1_nilai'));
            ...
            $this->load->view('baak/tugas_akhir_s1/penilaian',
            ...
            $this->session->set_flashdata('message', $text);
            redirect(site_url('baak/tugas_akhir/ta_s1/list_periode'));
        }
    }

    public function input_penilaian($id_trx,$periode){
        $data_masters=get_object_vars($this->Master_model->master_get(['id_trx' => $id_trx],'v_ta_s1_mhs_sidang'));  
        if($data_masters){

            $data_master=$this->baak_form->input_penilaian_sidang_s1($id_trx,$data_masters,$periode);
    ...
    public function input_penilaian_action($id_trx,$periode){
        $data_file = $this->Master_model->master_get(['id_trx'=>$id_trx], 'ta_s1_mhs_sidang');
        if($data_file){
            ...
            $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
                ...
                if ( ($this->form_validation->run() == TRUE)   ) {
                    ...
                    $this->Master_model->update_query(['id_trx'=>$data_file->id_list], $data, 'ta_s1_mhs_list');
                    ...
                    if($data_file->sidang=='ta' ){
                        ...
                        if(!$get_nilai_skala){
                            ...
                            $this->session->set_flashdata('message', $text);
                            redirect("baak/tugas_akhir/ta_s1/input_penilaian/".$id_trx.'/'.$periode);
                        }
                    ...
                    $this->session->set_flashdata('message', $text);
                    redirect(site_url('baak/tugas_akhir/ta_s1/penilaian/'.$id_trx.'/'.$periode));
                }else{
    ...
    public function json_list_yudusium_s1($periode){
        $this->load->model('datatable/Baak_dt', 'Baak_dt');
        
        header('Content-Type: application/json');
        echo $this->Baak_dt->json_list_yudusium_s1($periode);
    }
    ...
    public function yudusium_add_action($periode){
        ...
        $this->form_validation->set_error_delimiters('<span class="text-danger">', '</span>');
            ...
            if ( ($this->form_validation->run() == TRUE)   ) {
                $result->kode=null;
                $result->nama=null;
                if($this->input->post('id_rule',TRUE)){
                    $this->output->set_header('Access-Control-Allow-Origin: *');
                    $url =$this->url.'api/get_rule_administrasi_byid';
                    $data = array('key' => $this->key, 'id_rule' =>  $this->input->post('id_rule',TRUE) );
                    $options = array(
                ...
                $text = $this->alert->success('Yudisium Create');
                    $this->session->set_flashdata('message', $text);
                    redirect(site_url('baak/tugas_akhir/ta_s1/list_yudusium/'.$periode));
    ...
    public function daftar_yudisium($id_trx,$periode){
		...
		if(!$transkript){
			...
			$this->session->set_flashdata('message', $text);
			redirect("baak/tugas_akhir/ta_s1/yudisium_daftar/".$data_master->id_yudisium.'/'.$periode);
		}
    ...
    public function delete_rule($id){
        $data_file = $this->Master_model->master_get(['id_trx'=>$id], 'ta_s1_rule');
        if($data_file){
            $this->Master_model->delete_query(['id_trx'=> $id],'ta_s1_rule');

            $text = $this->alert->warning('Data successfully Delete');
				$this->session->set_flashdata('message', $text);
				redirect("baak/tugas_akhir/ta_s1/periode_rule/".$data_file->periode);
        }else{
