...
// // dev
// defined('url_siakad')      OR define('url_siakad', 'http://localhost/project/main_rosma/siakad/'); // highest automatically-assigned error code
// defined('url_siku')      OR define('url_siku', 'http://localhost/project/main_rosma/siku/'); // highest automatically-assigned error code
