                            ...
                            <h2 align="center">Bimbingan & Jadwal Sidang</h2>
                                ...
                                <div class="tab-content tabcontent-border">
                                    ...
                                    <?php if(  $this->session->userdata('role')=='mhs' ){ ?>
                                        <a href="<?php echo base_url(); ?>mahasiswa/ta_d3/add_bimbingan/<?php echo $data_masters->nim ?>" class="btn btn-block btn-warning">Add Bimbingan</a>
                                    <?php }else{  ?> 
                                        <a href="<?php echo base_url(); ?>dosen/ta_d3/add_bimbingan/<?php echo $data_masters->nim ?>" class="btn btn-block btn-warning">Add Bimbingan</a>
                                    <?php } ?> 
                                    <br>
                                            ...
                                            <table id="mytable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo base_url(); ?>mahasiswa/ta_d3/pendaftar_sidang_ta_d3/<?php echo $row->id_trx ?>" class="btn btn-block btn-warning">Daftar Sidang</a> *daftar atau update data</td>
                                                    </tr>
                                                    <?php }$no++;}} ?>
                                                </tbody>
                                            </table>
                                    ...
                                    <table id="mytable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url(); ?>mahasiswa/ta_d3/pendaftar_yudisium_ta_d3/<?php echo $row->id ?>" class="btn btn-block btn-warning">Daftar Yudisium</a> *daftar atau update data</td>
                                                </tr>
                                                <?php $no++;}} ?>
                                            </tbody>
