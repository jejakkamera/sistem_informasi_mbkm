<div class="page-wrapper">
	...
	<div class="container-fluid">
		...
		<button id="print" class="btn btn-default btn-outline" class="btn btn-success waves-effect waves-light" ><span><i
			...
			|| <a href="<?php echo base_url('baak/mahasiswa/transkrip_draf/').$mahasiswa->nim ?>" class="btn btn-success waves-effect waves-light" ><span><i
											class="fa fa-book"></i> Draf Transkript</span></a>
											<div class="col-md-12">
				<div class="card card-block printableArea">

				<?php if($this->session->userdata('role')=='pegawai_baak' ){ ?>	
					<a href="<?php echo base_url('baak/mahasiswa/isi_select/').$nim ?>"  class="btn btn-danger" > <span><i
											class="fa fa-plus"></i> Add FRS</span> </a>
				<?php } ?>							
					<hr>
					<div class="row">
						...
						<table width="100%"  >
							<tr>
								...
								<td width="40%" style="text-align:center !important"><h2>Hasil Studi</h2></td>
								<td width="30%" style="text-align:left !important">Form-STMIK-BAAK/HS</td>
							...
							<div class="table-responsive m-t-40" style="clear: both;">
								<table class="table table-hover">
									...
									foreach($kurikulum as $row){ 
										...
										<?php if($status=='transkrip_akademik' or $periode_lalu==$periode ){ ?>
											<tr>
												<td colspan='2' class="text-center">Periode <?php echo $periode_lalu; ?></td>
												
												<td colspan='2' class="text-center" >SKS Smt : <?php echo  number_format($total_sks_semester,2); ?></td>
												<td colspan='3' class="text-center" >Kumulatif Smt : <?php echo  number_format($total_kumulatif_semester,2); ?></td>
												<td colspan='2' class="text-center" >IPS : <?php echo  number_format($total_kumulatif_semester/$total_sks_semester,2); ?></td>
											</tr>
											<tr>
									...
									<?php $periode_lalu=$row->periode; if($status=='transkrip_akademik' or $periode_lalu==$periode ){ ?>
                                        ...
                                        <tr>
											...
											?></td>
                                            <td class="text-center"><?php echo $row->nilai_angka;?></td>
                                            <td class="text-center"><?php echo $row->nilai_huruf;?></td>
                                            <td class="text-center"><?php echo $row->nilai_index;?></td>
											<td class="text-center"><?php echo $row->nilai_kumulatif;
											
											?></td>
											<td class="text-center"><?php echo $row->transfer;?></td>
                                            <?php if($status=='hasil_studi'){ ?>       
											<td>
