...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="login-register login-sidebar"  style="background-image:url(<?php echo base_url(); ?>assets/login.jpg);background-size: cover;">
    ...
    <div class="card-block">
        ...
        <div class="form-group mt-3 ">
          <div class="col-xs-12">
            <h3>APP Info</h3>
            <p class="text-muted">Gunakan NPM/NIM sebagai Username & Password! </p>
