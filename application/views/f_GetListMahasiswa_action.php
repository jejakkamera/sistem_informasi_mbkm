    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    dom: "Bfrtip",
                    'ajax': {
                        'url':'<?php echo base_url();?>results.json',
                        'type': 'POST'
                    },
                    'columns': [
                        { data: 'nim' },
                        ...
                        { data: 'id_periode' },
                        { data: 'id_mahasiswa',"visible": false },
                        { data: 'id_prodi',"visible": false },
                        { data: 'nama_status_mahasiswa',"visible": false },
                        { data: 'id_registrasi_mahasiswa',"visible": false },
                    ],
                    select: true,
                });
                ...
                $("button").click(function(){
                    ...
                    data.each(function (value, index) {
                        now=now+10;
                        $.ajax({
                            url:"<?php echo base_url('admin/feeder/f_GetListMahasiswa_check');?>",
                            method:"POST",
                            data: value, 
                            async: false, 
