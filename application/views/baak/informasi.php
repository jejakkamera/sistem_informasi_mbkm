			...
			<div class="col-lg-12 col-xlg-12">
				...
				<div class="card">
					...
					<div class="card-block">
						...
						<form action="<?= base_url() ?>/baak/informasi/input_text" method="post">
			...
			<div class='col-lg-6 col-xlg-6'>
				...
				<div class="card">
					...
					<div class="card-block">
						...
						<?php echo form_open_multipart( base_url().'/baak/informasi/input_file');?>
							<div class="form-group">
                        ...
                        <ul>
                            <?php foreach ($data_file as $key) {?>
                                <li> <a href="<?= base_url().'/assets/informasi/'.$key['file'] ?>"><?= $key['file'] ?></a> <a class='ml-3' style="color: blue;" href="<?= base_url().'/baak/informasi/hapus_file/'.$key['id']?>"><i class="fa fa-trash"></i>Hapus</a>  </li>
                            <?php } ?>
                        </ul>
					</div>
				</div>
