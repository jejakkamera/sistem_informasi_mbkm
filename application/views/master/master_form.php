                ...
                <div class="row">
                    ...
                    <b><?php echo validation_errors(); ?></b> 
                        <div class="card card-outline-danger">
                          ...
                          <label class="col-sm-3 form-control-label"><?php echo $val['nama_form']; ?> <?php  if($val['required']==1){ echo '<span class="text-danger">*</span>';  }?> </label>
                          <div class="col-sm-9">
                          <?php 
                          ...
                          if(in_array($val['tipe'], $input_)){ ?>
                            ...
                            ?>" >
                            <?php echo form_error($val['kode_form']); ?>
                       ...
                       ?>
                        ...
                        <a type="button" class="btn btn-warning" onclick='<?php echo $val['kode_form']; ?>()'> <i class="fa fa-eraser"></i></a>        
                        <script type="text/javascript">
                                function <?php echo $val['kode_form']; ?>(){ 
                                    $('.js-data-example-ajax-<?php echo $val['kode_form']; ?>').select2('val','');  
                                    $('.js-data-example-ajax-<?php echo $val['kode_form']; ?>').html('');  
                                }
